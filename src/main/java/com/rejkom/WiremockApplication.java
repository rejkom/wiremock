...
public class WiremockApplication {
    ...
    public static void main(String[] args) {
        ...
        /* urlMatching vs urlPathMatching */

        // urlMatching - used when we want to match the entire URL, including the query params, e.g:
        stubFor(get(urlMatching("/api/data\\?type=OracleDb&name=Users_Table")));

        // urlPathMatching - used when we want to match just path part of th URL, ignoring query params e.g.
